...
`.trim(), m.message, {
    ...
    async onCall(json) {
        ...
        await this.sendMessage(from, 'JANGAN TELP BOT ATAU *BAN ?!?!*', MessageType.extendedText)
...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    unreg: '── 「 NOT REGISTERED 」 ──\nSilakan Register Terlebih Dahulu Sebelum Menggunakan Bot.'
  }[type]
